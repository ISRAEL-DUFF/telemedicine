	...
	<div class="row">
					...
					<form role="form"  action="registration.php" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data" >
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<option value="Islamabad">Calabar</option>
								<option value="Ahmadpur East">Lagos</option>
									<option value="Attock">Ibadan</option>
							<option value="Bahawalnagar">Uyo</option>
								<option value="Faisalabad">Porthacort</option>
									<option value="Gujranwala">Abuja</option>
											<option value="Gujrat">Owerri</option>
												<option value="Khanpur">Kaduna</option>
													<option value="Liaquat Pur">Kogi</option>
		...
		<div class="col-lg-5">
			<div class="bac-right-login-2">
				<h3>You’ll love being on TeleMed</h3>
				<ul>
					<li>Access TeleMed network of  patients.</li>
					<li>Let patients schedule appointments and video chat with you instantly, 24-7</li>
				</ul>
			</div>
		</div>
	</div>
